...
function calculators() {
  ...
  initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // Полные расчеты по формулам
  ...
  calcTotal(); // Получаем информацию с блоков "физической активности" и "пол"
  ...
  getStaticInformation('.calculating__choose_big div', 'calculating__choose-item_active'); // Функция обработки инпутов
...
/* harmony default export */ __webpack_exports__["default"] = (calculators);
...
function cards() {
  ...
  let menuField = document.querySelector('.menu__field div'); // Класс с параметрами для карточки и методом добавления карточки на страницу
...
function forms(formSelector, modalTimerId) {
  ...
  const forms = document.querySelectorAll(formSelector); // Объект с сообщениями для пользователя
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      e.preventDefault(); // создание блока для вывода сообщений пользователю
      ...
      const formData = new FormData(form); // преобразование FormData в JSON, путем перебора всех данных в FormData и добавлениях их в объект
      // Старый вариант
      // const object = {};
...
/* harmony export */   "closeModals": function() { return /* binding */ closeModals; },
...
function modals(triggerSelector, modalSelector, modalTimerId) {
  ...
  const modalTrigger = document.querySelectorAll(triggerSelector),
        modal = document.querySelector(modalSelector); // Открытие модального окна по кнопкам
...
function sliders({
  ...
  const sliders = document.querySelectorAll(slide),
        ...
        width = window.getComputedStyle(slidesWrapper).width; // Функция подсчитывающая побщее кол-во слайдов
  ...
  currentTotalCount(); // Функция для перелистывания назад/вперед
...
`;
  ...
  slidesField.style.transition = '0.5s all'; // Скрываем слайдеры которые не попадают в область видимости wrapper`а
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  const tabs = document.querySelectorAll(tabsSelector),
        ...
        tabsParent = document.querySelector(tabsParentSelector); // Скрываем табы и контент табов
  ...
  hideTabContent();
  showTabContent(); // Изменяем контент в табах при нажатии на категории 
...
function timers(id, deadline) {
  ...
  function setClock(selector, endTime) {
    ...
    updateClock(); // Обновление времени в таймере
...
/* harmony import */ var _modules_calculators__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/calculators */ "./js/modules/calculators.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const modalTimerId = setTimeout(function () {
    (0,_modules_modals__WEBPACK_IMPORTED_MODULE_2__.openModal)('.modal', modalTimerId);
  }, 50000);
  ...
  (0,_modules_timers__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-05-27');
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__.default)();
  (0,_modules_calculators__WEBPACK_IMPORTED_MODULE_5__.default)();
